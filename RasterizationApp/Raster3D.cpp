...
const float Raster3D::inchToMm = 25.4f;
const Matrix44f Raster3D::worldToCamera = { 0.707107, -0.331295, 0.624695, 0, 0, 0.883452, 0.468521, 0, -0.707107, -0.331295, 0.624695, 0, -1.63871, -5.747777, -40.400412, 1 };
const float Raster3D::nearClippingPLane = 1.f;
const float Raster3D::farClippingPLane = 1000.f;
float Raster3D::focalLength = 20.f; // in mm
// 35mm Full Aperture in inches
float Raster3D::filmApertureWidth = 0.980f;
float Raster3D::filmApertureHeight = 0.735f;

void Raster3D::computeScreenCoordinates(
